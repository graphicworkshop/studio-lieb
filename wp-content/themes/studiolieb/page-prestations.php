...
<?php while (have_posts()) : the_post(); ?>
	...
	<div class="container">
		<div class="row text-left">
			...
			<div class="col-sm-10 col-offset-sm-10 headline">
				...
				<div class="col-sm-4">
					<div class="iwt-wrapper clearfix">
						<div class="iwithtext">
							...
							<div class="iwt-text"> 
								<h4>Photographie de produits et packshots</h4>
								<p>Prises de vue et retouche pour tout types de produits : joaillerie, verrerie, cosmétique, textile, alimentaire... .</p>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-4">
					<div class="iwt-wrapper clearfix">
						<div class="iwithtext">
							...
							<div class="iwt-text"> 
								<h4>Photographie industrielle et reportage photo</h4>
				...
				<div class="col-sm-4">
					<div class="iwt-wrapper clearfix">
						<div class="iwithtext">
							...
							<div class="iwt-text"> 
								<h4>Photographie de mode et beauté</h4>
				...
				<div class="col-sm-4">
					<div class="iwt-wrapper clearfix">
						<div class="iwithtext">
							...
							<div class="iwt-text"> 
								<h4>Photographie sportive et instants d'actions</h4>
...
<section class="goto-tarifs">
	...
	<div class="row no-gutter">
				...
				<div class="col-sm-4">
					<img src="<?php bloginfo('template_url'); ?>/assets/img/illustration2.jpg" class="img-responsive">
				</div>

				<div class="col-sm-4">
					<img src="<?php bloginfo('template_url'); ?>/assets/img/illustration3.jpg" class="img-responsive">
				</div>
